...
class Boss(Ship, threading.Thread):
    ...
    #function used to determine whether the ship has hit one of the game area's borders, returns the ship's speed to be used further
    ...
    #currently unused, spawns laser objects at random time intervals
    def shoot(self):
